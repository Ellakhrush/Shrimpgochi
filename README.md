...
## 🕹️ Como rodar (Se você tiver coragem)
Abra o `index.html` no browser. Não precisa de nada fancy. Só você e o camarão.

## 🦐 A Psicologia do Camarão (Mecânicas)

### Stats (0–100)
| Stat | O que acontece? | Quando ele entra em pânico |
|------|-----------------|---------------------------|
| Fome | Aumenta... | ≥ 80 (Sinto um vazio... e não é só existencial) |
| Energia | Diminui... | ≤ 20 (Cansaço de ser um código) |
| Alegria | Diminui... | ≤ 20 (O vazio absoluto) |
| Higiene | Diminui... | ≤ 20 (Tô meio pegajoso) |
...
- `sleeping` → "Sonhando com oceanos de RAM"
- `dead` → "Finalmente virei um comentário no código" T-T

## 💖 Ações de Suporte Emocional
- 🍖 **Alimentar**: Tapa o buraco no estômago (e na alma).
- 🎾 **Brincar**: Distrai ele da verdade terrível da existência.
- 😴 **Dormir**: Reboot do sistema.
- 🛁 **Limpar**: Remove os resíduos de cache.
